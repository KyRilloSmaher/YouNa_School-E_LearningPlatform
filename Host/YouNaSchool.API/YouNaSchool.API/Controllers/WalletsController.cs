...
using YouNaSchool.Wallet.Application.Features.Commands.DeactivateWallet;
using YouNaSchool.Wallet.Application.Features.Commands.PayLecture;
using YouNaSchool.Wallet.Application.Features.Commands.ReActivateWallet;
using YouNaSchool.Wallet.Application.Features.Commands.RechargeWallet;
using YouNaSchool.Wallet.Application.Features.Queries.GetAllWallets;
using YouNaSchool.Wallet.Application.Features.Queries.GetWalletByStudentId;
using YouNaSchool.Wallet.Application.Features.Queries.GetWalletLedgerEntry;
...
namespace YouNaSchool.API.Controllers
{
    ...
    public class WalletsController : ControllerBase
    {
        ...
        [HttpPost("Pay-Lecture/{lectureId:guid}", Name = nameof(PurchaseLectureWithWalletAsync))]
        [ProducesResponseType(StatusCodes.Status202Accepted)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status422UnprocessableEntity)]
