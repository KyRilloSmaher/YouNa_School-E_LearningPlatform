...
namespace YouNaSchool.Wallet.Domain.Entities
{
    ...
    public sealed class Wallets : AggregateRoot
    {
        ...
        private readonly List<WalletRecharge> _recharges = new();
        /// <summary>
        ...
        public IReadOnlyCollection<WalletRecharge> Recharges => _recharges.AsReadOnly();
        ...
        public void Credit(Money amount, WalletTransactionSource source, Guid referenceId)
        {
            ...
            RaiseDomainEvent(new WalletCreditedEvent(Id, amount.Amount,StudentId));
        }
        ...
        public void Debit(Money amount, WalletTransactionSource source, Guid referenceId)
        {
            ...
            RaiseDomainEvent(new WalletDebitedEvent(Id, amount.Amount, referenceId,StudentId));
        }
        ...
        {
            IsActive = false;
            RaiseDomainEvent(new WalletDeactivatedEvent(Id , StudentId));
        }
        public void Reactivate()
        {
            IsActive = true;
            RaiseDomainEvent(new WalletReactivatedEvent(Id, StudentId));
        }
